...
#specify that row 1 is like 70% of the quadrant
        ...
        Q1row2=BoxLayout(orientation='horizontal', size_hint_y=0.15)
        ...
        Q2row2=BoxLayout(orientation='horizontal', size_hint_y=0.15)
        ...
        Q3row2.add_widget(Label(text='Water Pump Power', color=[0,0,0,1], font_size=18, size_hint_x=0.5))
        ...
        Q4row2.add_widget(Label(text='Fan Power', color=[0,0,0,1], font_size=18, size_hint_x=0.5))
